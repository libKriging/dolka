...
inversion rely on these methods. In a first step these methods will be
re-implemented in **dolka** (based on existing source codes from the
packages) in view of overloading the existing methods for the `"km"`
class. Then, we will suggest some light refactoring to the authors of
**DiceOptim**, **KrigeInv** and maybe to those of other packages using
